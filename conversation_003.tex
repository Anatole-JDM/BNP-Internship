...
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}\item Identifier précisément l'intention utilisateur: What is ground water contamination?\n\item Récupérer les faits nécessaires pour répondre à: What is ground water contamination?\n\item Vérifier les contraintes temporelles ou définitionnelles implicites liées à: What is ground water contamination?\n\end{itemize}}}
\[6pt]
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} Can it be clean up? (Contexte: What is ground water contamination?)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}\item Identifier précisément l'intention utilisateur: Can it be clean up? (Doc couvert au Turn 1.)\n\item Récupérer les faits nécessaires pour répondre à: Can it be clean up? (Doc couvert au Turn 1.)\n\item Vérifier les contraintes temporelles ou définitionnelles implicites liées à: Can it be clean up? (Doc couvert au Turn 1.)\n\end{itemize}}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} What is it? (Contexte: Can it be clean up?)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}\item Identifier précisément l'intention utilisateur: What is it? (Doc couvert au Turn 1.)\n\item Récupérer les faits nécessaires pour répondre à: What is it? (Doc couvert au Turn 1.)\n\item Vérifier les contraintes temporelles ou définitionnelles implicites liées à: What is it? (Doc couvert au Turn 1.)\n\end{itemize}}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Optimized Retrieval Queries:}\n\begin{itemize}\item Aucun gap: toutes les sous-questions sont déjà couvertes.\n\end{itemize}}}
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} What are the suppliers for the city? (En tenant compte du contexte des tours précédents.)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}\item Identifier précisément l'intention utilisateur: What are the suppliers for the city? (Doc couvert au Turn 1.)\n\item Récupérer les faits nécessaires pour répondre à: What are the suppliers for the city? (Doc couvert au Turn 1.)\n\item Vérifier les contraintes temporelles ou définitionnelles implicites liées à: What are the suppliers for the city? (Doc couvert au Turn 1.)\n\end{itemize}}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Optimized Retrieval Queries:}\n\begin{itemize}\item Aucun gap: toutes les sous-questions sont déjà couvertes.\n\end{itemize}}}
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} Pollution (En tenant compte du contexte des tours précédents.)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}\item Identifier précisément l'intention utilisateur: Pollution? (Doc couvert au Turn 1.)\n\item Récupérer les faits nécessaires pour répondre à: Pollution? (Doc couvert au Turn 1.)\n\item Vérifier les contraintes temporelles ou définitionnelles implicites liées à: Pollution? (Doc couvert au Turn 1.)\n\end{itemize}}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Optimized Retrieval Queries:}\n\begin{itemize}\item Aucun gap: toutes les sous-questions sont déjà couvertes.\n\end{itemize}}}
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} In water (En tenant compte du contexte des tours précédents.)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}\item Identifier précisément l'intention utilisateur: In water? (Doc couvert au Turn 1.)\n\item Récupérer les faits nécessaires pour répondre à: In water? (Doc couvert au Turn 1.)\n\item Vérifier les contraintes temporelles ou définitionnelles implicites liées à: In water? (Doc couvert au Turn 1.)\n\end{itemize}}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Optimized Retrieval Queries:}\n\begin{itemize}\item Aucun gap: toutes les sous-questions sont déjà couvertes.\n\end{itemize}}}
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} Sollutions (En tenant compte du contexte des tours précédents.)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}\item Identifier précisément l'intention utilisateur: Sollutions? (Doc couvert au Turn 1.)\n\item Récupérer les faits nécessaires pour répondre à: Sollutions? (Doc couvert au Turn 1.)\n\item Vérifier les contraintes temporelles ou définitionnelles implicites liées à: Sollutions? (Doc couvert au Turn 1.)\n\end{itemize}}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Optimized Retrieval Queries:}\n\begin{itemize}\item Aucun gap: toutes les sous-questions sont déjà couvertes.\n\end{itemize}}}

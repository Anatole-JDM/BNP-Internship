...
\vspace{0.4em}
\vspace{0.5em}
\noindent{\small\textcolor{usercolor}{\textbf{$\triangleright$\enspace User --- Turn~1}}}\hfill{\tiny\textcolor{gray}{Comparative, Non-Question, Opinion $\cdot$ ANSWERABLE}}
\begin{userbubble}
...
\end{refanswerenv}
\vspace{0.5em}
\noindent{\small\textcolor{usercolor}{\textbf{$\triangleright$\enspace User --- Turn~2}}}\hfill{\tiny\textcolor{gray}{Opinion $\cdot$ Clarification $\cdot$ ANSWERABLE}}
\begin{userbubble}
...
\end{refanswerenv}
\vspace{0.5em}
\noindent{\small\textcolor{usercolor}{\textbf{$\triangleright$\enspace User --- Turn~3}}}\hfill{\tiny\textcolor{gray}{Opinion $\cdot$ Follow-up $\cdot$ UNANSWERABLE}}
\begin{userbubble}
...
\end{refanswerenv}
\vspace{0.5em}
\noindent{\small\textcolor{usercolor}{\textbf{$\triangleright$\enspace User --- Turn~5}}}\hfill{\tiny\textcolor{gray}{Opinion $\cdot$ Follow-up $\cdot$ ANSWERABLE}}
\begin{userbubble}
...
\end{refanswerenv}
\vspace{0.5em}
\noindent{\small\textcolor{usercolor}{\textbf{$\triangleright$\enspace User --- Turn~6}}}\hfill{\tiny\textcolor{gray}{Opinion $\cdot$ Follow-up $\cdot$ ANSWERABLE}}
\begin{userbubble}
...
\end{refanswerenv}
\vspace{0.5em}
\noindent{\small\textcolor{usercolor}{\textbf{$\triangleright$\enspace User --- Turn~7}}}\hfill{\tiny\textcolor{gray}{Explanation $\cdot$ Follow-up $\cdot$ ANSWERABLE}}
\begin{userbubble}
...
\end{refanswerenv}
\vspace{0.5em}
\noindent{\small\textcolor{usercolor}{\textbf{$\triangleright$\enspace User --- Turn~8}}}\hfill{\tiny\textcolor{gray}{Follow-up $\cdot$ Explanation $\cdot$ UNANSWERABLE}}
\begin{userbubble}

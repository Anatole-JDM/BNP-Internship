...
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}\item Identifier précisément l'intention utilisateur: What's the difference between Market Cap and NAV?\n\item Récupérer les faits nécessaires pour répondre à: What's the difference between Market Cap and NAV?\n\item Vérifier les contraintes temporelles ou définitionnelles implicites liées à: What's the difference between Market Cap and NAV?\n\end{itemize}}}
\[6pt]
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} Which is more important? (En tenant compte du contexte des tours précédents.)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}\item Identifier précisément l'intention utilisateur: Which is more important? (Doc couvert au Turn 1.)\n\item Récupérer les faits nécessaires pour répondre à: Which is more important? (Doc couvert au Turn 1.)\n\item Vérifier les contraintes temporelles ou définitionnelles implicites liées à: Which is more important? (Doc couvert au Turn 1.)\n\end{itemize}}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} enterprise value (En tenant compte du contexte des tours précédents.)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}\item Identifier précisément l'intention utilisateur: enterprise value? (Doc couvert au Turn 1.)\n\item Récupérer les faits nécessaires pour répondre à: enterprise value? (Doc couvert au Turn 1.)\n\item Vérifier les contraintes temporelles ou définitionnelles implicites liées à: enterprise value? (Doc couvert au Turn 1.)\n\end{itemize}}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Optimized Retrieval Queries:}\n\begin{itemize}\item Aucun gap: toutes les sous-questions sont déjà couvertes.\n\end{itemize}}}
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} How is it calculated? (Contexte: enterprise value)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}\item Identifier précisément l'intention utilisateur: How is it calculated? (Doc couvert au Turn 1.)\n\item Récupérer les faits nécessaires pour répondre à: How is it calculated? (Doc couvert au Turn 1.)\n\item Vérifier les contraintes temporelles ou définitionnelles implicites liées à: How is it calculated? (Doc couvert au Turn 1.)\n\end{itemize}}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Optimized Retrieval Queries:}\n\begin{itemize}\item Aucun gap: toutes les sous-questions sont déjà couvertes.\n\end{itemize}}}
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} What is WACC? (En tenant compte du contexte des tours précédents.)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}\item Identifier précisément l'intention utilisateur: What is WACC? (Doc couvert au Turn 1.)\n\item Récupérer les faits nécessaires pour répondre à: What is WACC? (Doc couvert au Turn 1.)\n\item Vérifier les contraintes temporelles ou définitionnelles implicites liées à: What is WACC? (Doc couvert au Turn 1.)\n\end{itemize}}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Optimized Retrieval Queries:}\n\begin{itemize}\item Aucun gap: toutes les sous-questions sont déjà couvertes.\n\end{itemize}}}
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} Is the WACC formula highly reliable? (En tenant compte du contexte des tours précédents.)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}\item Identifier précisément l'intention utilisateur: Is the WACC formula highly reliable? (Doc couvert au Turn 1.)\n\item Récupérer les faits nécessaires pour répondre à: Is the WACC formula highly reliable? (Doc couvert au Turn 1.)\n\item Vérifier les contraintes temporelles ou définitionnelles implicites liées à: Is the WACC formula highly reliable? (Doc couvert au Turn 1.)\n\end{itemize}}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Optimized Retrieval Queries:}\n\begin{itemize}\item Aucun gap: toutes les sous-questions sont déjà couvertes.\n\end{itemize}}}
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} What is the ideal formula to evaluate a company? (En tenant compte du contexte des tours précédents.)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}\item Identifier précisément l'intention utilisateur: What is the ideal formula to evaluate a company? (Doc couvert au Turn 1.)\n\item Récupérer les faits nécessaires pour répondre à: What is the ideal formula to evaluate a company? (Doc couvert au Turn 1.)\n\item Vérifier les contraintes temporelles ou définitionnelles implicites liées à: What is the ideal formula to evaluate a company? (Doc couvert au Turn 1.)\n\end{itemize}}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Optimized Retrieval Queries:}\n\begin{itemize}\item Aucun gap: toutes les sous-questions sont déjà couvertes.\n\end{itemize}}}

...
\item Clarifier l'intention exacte: "What are the sheltered rooms designated for use?
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} What items should I keep? (avec résolution des références au contexte précédent)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}
\item Clarifier l'intention exacte: What items should I keep?
\item Identifier les faits utiles pour répondre à cette question.
\item Vérifier les contraintes temporelles/définitions implicites.
\end{itemize}}}
\[6pt]
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} Is it the same for earthquakes? (avec résolution des références au contexte précédent)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}
\item Clarifier l'intention exacte: Is it the same for earthquakes?
\item Identifier les faits utiles pour répondre à cette question.
\item Vérifier les contraintes temporelles/définitions implicites.
\end{itemize}}}
\[6pt]
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} Which state has more wildfires? (avec résolution des références au contexte précédent)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}
\item Clarifier l'intention exacte: Which state has more wildfires?
\item Identifier les faits utiles pour répondre à cette question.
\item Vérifier les contraintes temporelles/définitions implicites.
\end{itemize}}}
\[6pt]
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} What causes wildfires? (avec résolution des références au contexte précédent)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}
\item Clarifier l'intention exacte: What causes wildfires?
\item Identifier les faits utiles pour répondre à cette question.
\item Vérifier les contraintes temporelles/définitions implicites.
\end{itemize}}}
\[6pt]
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} Why doesn't the government prevent people from living in areas prone to flooding? (avec résolution des références au contexte précédent)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}
\item Clarifier l'intention exacte: Why doesn't the government prevent people from living in areas prone to flooding?
\item Vérifier les contraintes temporelles/définitions implicites.
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} Is flooding the most common type of disaster? (avec résolution des références au contexte précédent)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}
\item Clarifier l'intention exacte: Is flooding the most common type of disaster?
\item Identifier les faits utiles pour répondre à cette question.
\item Vérifier les contraintes temporelles/définitions implicites.
\end{itemize}}}
\[6pt]
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} Is climate change the cause of natural disasters? (avec résolution des références au contexte précédent)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}
\item Clarifier l'intention exacte: Is climate change the cause of natural disasters?
\item Vérifier les contraintes temporelles/définitions implicites.
\item Cette sous-question est déjà couverte par des documents précédents. (Doc Turn 5.)
\end{itemize}}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]

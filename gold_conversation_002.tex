...
\begin{center}
{\LARGE\bfseries MTRAG Conversation #2}
\par\medskip
...
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} "What are the sheltered rooms designated for use?}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:} 
\begin{itemize}
\item Define the exact scope of the user question: '"What are the sheltered rooms designated for use'.
\item Find factual evidence directly answering: '"What are the sheltered rooms designated for use'.
\item Check whether time, location, or entity disambiguation is needed for '"What are the sheltered rooms designated for use'.
\end{itemize}
}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Retrieval Query:} '"What are the sheltered rooms designated for use'. '"What are the sheltered rooms designated for use'. '"What are the sheltered rooms designated for use'.}}
\end{center}
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} What items should I keep? (Resolved context: this refers to What from previous turns.)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:} 
\begin{itemize}
\item Define the exact scope of the user question: 'What items should I keep'.
\item Find factual evidence directly answering: 'What items should I keep'.
\item Check whether time, location, or entity disambiguation is needed for 'What items should I keep'.
\end{itemize}
}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Retrieval Query:} 'What items should I keep'. 'What items should I keep'. 'What items should I keep'.}}
\end{center}
\noindent\hfill{\small\textcolor{agentcolor}{\textbf{Agent\enspace$\triangleleft$}}}
\begin{agentbubble}
...
\end{refanswerenv}
\vspace{0.5em}
\noindent{\small\textcolor{usercolor}{\textbf{$\triangleright$\enspace User --- Turn~3}}}\hfill{\tiny\textcolor{gray}{Explanation $\cdot$ Summarization $\cdot$ ANSWERABLE $\cdot$ Clarification}}
\begin{userbubble}
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} Is it the same for earthquakes? (Resolved context: this refers to What from previous turns.)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:} 
\begin{itemize}
\item Define the exact scope of the user question: 'Is it the same for earthquakes'.
\item Find factual evidence directly answering: 'Is it the same for earthquakes'.
\item Check whether time, location, or entity disambiguation is needed for 'Is it the same for earthquakes'.
\end{itemize}
}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Retrieval Query:} 'Is it the same for earthquakes'. 'Is it the same for earthquakes'. 'Is it the same for earthquakes'.}}
\end{center}
\noindent\hfill{\small\textcolor{agentcolor}{\textbf{Agent\enspace$\triangleleft$}}}
\begin{agentbubble}
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} Which state has more wildfires? (Using prior conversation context for disambiguation.)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:} 
\begin{itemize}
\item Define the exact scope of the user question: 'Which state has more wildfires'.
\item Find factual evidence directly answering: 'Which state has more wildfires'.
\item Check whether time, location, or entity disambiguation is needed for 'Which state has more wildfires'.
\end{itemize}
}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Retrieval Query:} 'Which state has more wildfires'. 'Which state has more wildfires'. 'Which state has more wildfires'.}}
\end{center}
\noindent\hfill{\small\textcolor{agentcolor}{\textbf{Agent\enspace$\triangleleft$}}}
\begin{agentbubble}
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} What causes wildfires? (Using prior conversation context for disambiguation.)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:} 
\begin{itemize}
\item Define the exact scope of the user question: 'What causes wildfires'.
\item Find factual evidence directly answering: 'What causes wildfires'.
\item Check whether time, location, or entity disambiguation is needed for 'What causes wildfires'.
\end{itemize}
}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Retrieval Query:} 'What causes wildfires'. 'What causes wildfires'. 'What causes wildfires'.}}
\end{center}
\noindent\hfill{\small\textcolor{agentcolor}{\textbf{Agent\enspace$\triangleleft$}}}
\begin{agentbubble}
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} Why doesn't the government prevent people from living in areas prone to flooding? (Using prior conversation context for disambiguation.)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:} 
\begin{itemize}
\item Define the exact scope of the user question: 'Why doesn't the government prevent people from living in areas prone to flooding'.
\item Find factual evidence directly answering: 'Why doesn't the government prevent people from living in areas prone to flooding'. (Doc 1.)
\item Check whether time, location, or entity disambiguation is needed for 'Why doesn't the government prevent people from living in areas prone to flooding'.
\end{itemize}
}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Retrieval Query:} 'Why doesn't the government prevent people from living in areas prone to flooding'. 'Why doesn't the government prevent people from living in areas prone to flooding'.}}
\end{center}
\noindent\hfill{\small\textcolor{agentcolor}{\textbf{Agent\enspace$\triangleleft$}}}
\begin{agentbubble}
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} Is flooding the most common type of disaster? (Using prior conversation context for disambiguation.)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:} 
\begin{itemize}
\item Define the exact scope of the user question: 'Is flooding the most common type of disaster'.
\item Find factual evidence directly answering: 'Is flooding the most common type of disaster'.
\item Check whether time, location, or entity disambiguation is needed for 'Is flooding the most common type of disaster'.
\end{itemize}
}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Retrieval Query:} 'Is flooding the most common type of disaster'. 'Is flooding the most common type of disaster'. 'Is flooding the most common type of disaster'.}}
\end{center}
\noindent\hfill{\small\textcolor{agentcolor}{\textbf{Agent\enspace$\triangleleft$}}}
\begin{agentbubble}
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} Is climate change the cause of natural disasters? (Using prior conversation context for disambiguation.)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:} 
\begin{itemize}
\item Define the exact scope of the user question: 'Is climate change the cause of natural disasters'.
\item Find factual evidence directly answering: 'Is climate change the cause of natural disasters'. (Doc 5.)
\item Check whether time, location, or entity disambiguation is needed for 'Is climate change the cause of natural disasters'.
\end{itemize}
}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Retrieval Query:} 'Is climate change the cause of natural disasters'. 'Is climate change the cause of natural disasters'.}}
\end{center}
\noindent\hfill{\small\textcolor{agentcolor}{\textbf{Agent\enspace$\triangleleft$}}}
\begin{agentbubble}

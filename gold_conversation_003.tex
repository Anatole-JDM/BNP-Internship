...
\begin{center}
{\LARGE\bfseries MTRAG Conversation #3}
\par\medskip
...
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} What is ground water contamination?}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:} 
\begin{itemize}
\item Define the exact scope of the user question: 'What is ground water contamination'.
\item Find factual evidence directly answering: 'What is ground water contamination'.
\item Check whether time, location, or entity disambiguation is needed for 'What is ground water contamination'.
\end{itemize}
}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Retrieval Query:} 'What is ground water contamination'. 'What is ground water contamination'. 'What is ground water contamination'.}}
\end{center}
...
\end{refanswerenv}
\vspace{0.5em}
\noindent{\small\textcolor{usercolor}{\textbf{$\triangleright$\enspace User --- Turn~2}}}\hfill{\tiny\textcolor{gray}{Factoid $\cdot$ Summarization $\cdot$ ANSWERABLE $\cdot$ Follow-up}}
\begin{userbubble}
Can it be clean up?
\end{userbubble}
\begin{center}
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} Can it be clean up? (Resolved context: this refers to What from previous turns.)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:} 
\begin{itemize}
\item Define the exact scope of the user question: 'Can it be clean up'.
\item Find factual evidence directly answering: 'Can it be clean up'. (Doc 1.)
\item Check whether time, location, or entity disambiguation is needed for 'Can it be clean up'.
\end{itemize}
}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Retrieval Query:} 'Can it be clean up'. 'Can it be clean up'.}}
\end{center}
\noindent\hfill{\small\textcolor{agentcolor}{\textbf{Agent\enspace$\triangleleft$}}}
\begin{agentbubble}
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} What is it? (Resolved context: this refers to Can from previous turns.)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:} 
\begin{itemize}
\item Define the exact scope of the user question: 'What is it'.
\item Find factual evidence directly answering: 'What is it'.
\item Check whether time, location, or entity disambiguation is needed for 'What is it'.
\end{itemize}
}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Retrieval Query:} 'What is it'. 'What is it'. 'What is it'.}}
\end{center}
\noindent\hfill{\small\textcolor{agentcolor}{\textbf{Agent\enspace$\triangleleft$}}}
\begin{agentbubble}
...
\end{refanswerenv}
\vspace{0.5em}
\noindent{\small\textcolor{usercolor}{\textbf{$\triangleright$\enspace User --- Turn~4}}}\hfill{\tiny\textcolor{gray}{Summarization $\cdot$ ANSWERABLE $\cdot$ Follow-up}}
\begin{userbubble}
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} What are the suppliers for the city? (Resolved context: this refers to What from previous turns.)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:} 
\begin{itemize}
\item Define the exact scope of the user question: 'What are the suppliers for the city'.
\item Find factual evidence directly answering: 'What are the suppliers for the city'.
\item Check whether time, location, or entity disambiguation is needed for 'What are the suppliers for the city'.
\end{itemize}
}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Retrieval Query:} 'What are the suppliers for the city'. 'What are the suppliers for the city'. 'What are the suppliers for the city'.}}
\end{center}
\noindent\hfill{\small\textcolor{agentcolor}{\textbf{Agent\enspace$\triangleleft$}}}
\begin{agentbubble}
...
\end{refanswerenv}
\vspace{0.5em}
\noindent{\small\textcolor{usercolor}{\textbf{$\triangleright$\enspace User --- Turn~5}}}\hfill{\tiny\textcolor{gray}{Keyword $\cdot$ ANSWERABLE $\cdot$ Clarification}}
\begin{userbubble}
Pollution
\end{userbubble}
\begin{center}
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} Pollution? (Using prior conversation context for disambiguation.)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:} 
\begin{itemize}
\item Define the exact scope of the user question: 'Pollution'.
\item Find factual evidence directly answering: 'Pollution'.
\item Check whether time, location, or entity disambiguation is needed for 'Pollution'.
\end{itemize}
}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Retrieval Query:} 'Pollution'. 'Pollution'. 'Pollution'.}}
\end{center}
\noindent\hfill{\small\textcolor{agentcolor}{\textbf{Agent\enspace$\triangleleft$}}}
\begin{agentbubble}
...
\end{refanswerenv}
\vspace{0.5em}
\noindent{\small\textcolor{usercolor}{\textbf{$\triangleright$\enspace User --- Turn~6}}}\hfill{\tiny\textcolor{gray}{Non-Question $\cdot$ ANSWERABLE $\cdot$ Clarification}}
\begin{userbubble}
In water
\end{userbubble}
\begin{center}
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} In water? (Using prior conversation context for disambiguation.)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:} 
\begin{itemize}
\item Define the exact scope of the user question: 'In water'.
\item Find factual evidence directly answering: 'In water'.
\item Check whether time, location, or entity disambiguation is needed for 'In water'.
\end{itemize}
}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Retrieval Query:} 'In water'. 'In water'. 'In water'.}}
\end{center}
\noindent\hfill{\small\textcolor{agentcolor}{\textbf{Agent\enspace$\triangleleft$}}}
\begin{agentbubble}
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} Sollutions? (Using prior conversation context for disambiguation.)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:} 
\begin{itemize}
\item Define the exact scope of the user question: 'Sollutions'.
\item Find factual evidence directly answering: 'Sollutions'.
\item Check whether time, location, or entity disambiguation is needed for 'Sollutions'.
\end{itemize}
}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Retrieval Query:} 'Sollutions'. 'Sollutions'. 'Sollutions'.}}
\end{center}
\noindent\hfill{\small\textcolor{agentcolor}{\textbf{Agent\enspace$\triangleleft$}}}
\begin{agentbubble}

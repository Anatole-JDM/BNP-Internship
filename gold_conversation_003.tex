...
\item Clarifier l'intention exacte: What is ground water contamination?
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} Can it be clean up? (avec résolution des références au contexte précédent)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}
\item Clarifier l'intention exacte: Can it be clean up?
\item Vérifier les contraintes temporelles/définitions implicites.
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} What is it? (avec résolution des références au contexte précédent)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}
\item Clarifier l'intention exacte: What is it?
\item Identifier les faits utiles pour répondre à cette question.
\item Vérifier les contraintes temporelles/définitions implicites.
\end{itemize}}}
\[6pt]
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} What are the suppliers for the city? (avec résolution des références au contexte précédent)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}
\item Clarifier l'intention exacte: What are the suppliers for the city?
\item Identifier les faits utiles pour répondre à cette question.
\item Vérifier les contraintes temporelles/définitions implicites.
\end{itemize}}}
\[6pt]
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} Pollution (avec résolution des références au contexte précédent)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}
\item Clarifier l'intention exacte: Pollution?
\item Identifier les faits utiles pour répondre à cette question.
\item Vérifier les contraintes temporelles/définitions implicites.
\end{itemize}}}
\[6pt]
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} In water (avec résolution des références au contexte précédent)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}
\item Clarifier l'intention exacte: In water?
\item Identifier les faits utiles pour répondre à cette question.
\item Vérifier les contraintes temporelles/définitions implicites.
\end{itemize}}}
\[6pt]
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} Sollutions (avec résolution des références au contexte précédent)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}
\item Clarifier l'intention exacte: Sollutions?
\item Identifier les faits utiles pour répondre à cette question.
\item Vérifier les contraintes temporelles/définitions implicites.
\end{itemize}}}
\[6pt]

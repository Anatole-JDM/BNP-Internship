...
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}\item Identifier précisément l'intention utilisateur: Freelancer: Should I start a second bank account?\n\item Récupérer les faits nécessaires pour répondre à: Freelancer: Should I start a second bank account?\n\item Vérifier les contraintes temporelles ou définitionnelles implicites liées à: Freelancer: Should I start a second bank account?\n\end{itemize}}}
\[6pt]
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} Is it free to open a second bank account? (Contexte: Freelancer: Should I start a second bank account?)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}\item Identifier précisément l'intention utilisateur: Is it free to open a second bank account? (Doc couvert au Turn 1.)\n\item Récupérer les faits nécessaires pour répondre à: Is it free to open a second bank account? (Doc couvert au Turn 1.)\n\item Vérifier les contraintes temporelles ou définitionnelles implicites liées à: Is it free to open a second bank account? (Doc couvert au Turn 1.)\n\end{itemize}}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} if it is free, then I should make a second account for my business. how can I create? (Contexte: Is it free to open a second bank account?)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}\item Identifier précisément l'intention utilisateur: if it is free, then I should make a second account for my business. how can I create? (Doc couvert au Turn 1.)\n\item Récupérer les faits nécessaires pour répondre à: if it is free, then I should make a second account for my business. how can I create? (Doc couvert au Turn 1.)\n\item Vérifier les contraintes temporelles ou définitionnelles implicites liées à: if it is free, then I should make a second account for my business. how can I create? (Doc couvert au Turn 1.)\n\end{itemize}}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Optimized Retrieval Queries:}\n\begin{itemize}\item Aucun gap: toutes les sous-questions sont déjà couvertes.\n\end{itemize}}}
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} what? you said it is free to open one! (Contexte: if it is free, then I should make a second account for my business. how can I cr)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}\item Identifier précisément l'intention utilisateur: what? you said it is free to open one!? (Doc couvert au Turn 1.)\n\item Récupérer les faits nécessaires pour répondre à: what? you said it is free to open one!? (Doc couvert au Turn 1.)\n\item Vérifier les contraintes temporelles ou définitionnelles implicites liées à: what? you said it is free to open one!? (Doc couvert au Turn 1.)\n\end{itemize}}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Optimized Retrieval Queries:}\n\begin{itemize}\item Aucun gap: toutes les sous-questions sont déjà couvertes.\n\end{itemize}}}
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} should I set up my second bank account with different bank I have right now? (En tenant compte du contexte des tours précédents.)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}\item Identifier précisément l'intention utilisateur: should I set up my second bank account with different bank I have right now? (Doc couvert au Turn 1.)\n\item Récupérer les faits nécessaires pour répondre à: should I set up my second bank account with different bank I have right now? (Doc couvert au Turn 1.)\n\item Vérifier les contraintes temporelles ou définitionnelles implicites liées à: should I set up my second bank account with different bank I have right now? (Doc couvert au Turn 1.)\n\end{itemize}}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Optimized Retrieval Queries:}\n\begin{itemize}\item Aucun gap: toutes les sous-questions sont déjà couvertes.\n\end{itemize}}}
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} what are people's experience with using two bank accounts? (En tenant compte du contexte des tours précédents.)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}\item Identifier précisément l'intention utilisateur: what are people's experience with using two bank accounts? (Doc couvert au Turn 1.)\n\item Récupérer les faits nécessaires pour répondre à: what are people's experience with using two bank accounts? (Doc couvert au Turn 1.)\n\item Vérifier les contraintes temporelles ou définitionnelles implicites liées à: what are people's experience with using two bank accounts? (Doc couvert au Turn 1.)\n\end{itemize}}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Optimized Retrieval Queries:}\n\begin{itemize}\item Aucun gap: toutes les sous-questions sont déjà couvertes.\n\end{itemize}}}
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} can you let me know advantages of using two bank accounts? (En tenant compte du contexte des tours précédents.)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}\item Identifier précisément l'intention utilisateur: can you let me know advantages of using two bank accounts? (Doc couvert au Turn 1.)\n\item Récupérer les faits nécessaires pour répondre à: can you let me know advantages of using two bank accounts? (Doc couvert au Turn 1.)\n\item Vérifier les contraintes temporelles ou définitionnelles implicites liées à: can you let me know advantages of using two bank accounts? (Doc couvert au Turn 1.)\n\end{itemize}}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Optimized Retrieval Queries:}\n\begin{itemize}\item Aucun gap: toutes les sous-questions sont déjà couvertes.\n\end{itemize}}}
...
$\downarrow$ \textbf{Disambiguation}
\[6pt]
\fcolorbox{blue}{blue!10}{\parbox{0.85\linewidth}{\textbf{Rewritten Query:} I am wondering which bank I should start looking at (En tenant compte du contexte des tours précédents.)}}
\[6pt]
$\downarrow$ \textbf{Breakdown}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Breakdown:}\n\begin{itemize}\item Identifier précisément l'intention utilisateur: I am wondering which bank I should start looking at? (Doc couvert au Turn 1.)\n\item Récupérer les faits nécessaires pour répondre à: I am wondering which bank I should start looking at? (Doc couvert au Turn 1.)\n\item Vérifier les contraintes temporelles ou définitionnelles implicites liées à: I am wondering which bank I should start looking at? (Doc couvert au Turn 1.)\n\end{itemize}}}
\[6pt]
$\downarrow$ \textbf{Gap Identification}
\[6pt]
\fcolorbox{purple}{purple!10}{\parbox{0.85\linewidth}{\textbf{Optimized Retrieval Queries:}\n\begin{itemize}\item Aucun gap: toutes les sous-questions sont déjà couvertes.\n\end{itemize}}}
